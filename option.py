...
def args_parser():
    ...
    parser.add_argument('--epochs', type=int, default=200, help='End epoch for training')
    parser.add_argument("--trainset_num", default=20000, type=int, help='The number of training samples of each epoch')
    parser.add_argument("--test_model_epoch", default=200, type=int, help='Test Model Epoch')
